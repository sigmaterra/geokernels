...
def geodesic_geographiclib(u,v):
    """
    Compute the geodesic distance between two points.
    Computation using GeographicLib.

    Requirement: geographiclib and import Geodesic:
    from geographiclib.geodesic import Geodesic

    See function test_geodesic_geographiclib()
    in module test_geodesics.py
    ...
    distance : float, in meters
    """
    return Geodesic.WGS84.Inverse(u[0], u[1], v[0], v[1])['s12']
